...
def calculate_val_metrics_ihdp(
    ...
    pseudo_ite_value = pseudo_ite["ite"]
    std_rmse_ = std_rmse(predictions['pred_y_A0'], predictions['pred_y_A1'], predictions['ite'])
    ipw_rmse_ = ipw_rmse(predictions['y'], predictions['t'], predictions['t_prob'], predictions['ite'])
