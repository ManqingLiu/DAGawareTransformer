...
def predict(model: nn.Module,
    ...
    #dataset = CausalDataset(data, dag, add_u=True, n_uniform_variables=1, seed_value=0)
    ...
    prediction_transformer = PredictionTransformer(dag)
...
if __name__ == '__main__':
    ...
    predictions_train = predict(model, dataset, dag, dataloader, model_file=args.model_file)
    ...
    predictions_train_A1 = predict(model, data_A1, dag, dataloader_A1, model_file=args.model_train_file)
    ...
    dataloader_A0 = DataLoader(dataset_A0,
                               ...
                               shuffle=True,
                               collate_fn=dataset.collate_fn)
    predictions_train_A0 = predict(model, data_A0, dag, dataloader_A0, model_file=args.model_train_file)
    ...
    dataloader = DataLoader(dataset,
                            ...
                            shuffle=True,
                            collate_fn=dataset.collate_fn)
    predictions_holdout = predict(model, data, dag, dataloader, model_file=args.model_file)
    ...
    predictions_holdout_A1 = predict(model, data_A1, dag, dataloader_A1, model_file=args.model_holdout_file)
    ...
    dataloader_A0 = DataLoader(dataset_A0,
                               ...
                               shuffle=True,
                               collate_fn=dataset.collate_fn)
    predictions_holdout_A0 = predict(model, data_A0, dag, dataloader_A0, model_file=args.model_holdout_file)
