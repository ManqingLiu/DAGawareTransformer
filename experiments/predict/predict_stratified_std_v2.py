...
ATE_IPTW_stable = IPTW_stabilized(df_IPTW['t'], df_IPTW['y'], df_IPTW['pred_t'])
print(f"Predicted ATE from stabilized IPTW: {ATE_IPTW_stable:.4f}")
rmse_IPTW_stable = rmse(ATE_IPTW_stable, ATE_true)
print(f"RMSE from stabilized IPTW: {rmse_IPTW_stable:.4f}")

ATE_IPTW_unstable = IPTW_unstabilized(df_IPTW['t'], df_IPTW['y'], df_IPTW['pred_t'])
print(f"Predicted ATE from unstabilized IPTW: {ATE_IPTW_unstable:.4f}")
rmse_IPTW_unstable = rmse(ATE_IPTW_unstable, ATE_true)
print(f"RMSE from unstabilized IPTW: {rmse_IPTW_unstable:.4f}")
...
ATE_val = AIPW(val_df['t'], val_df['pred_t'], val_df['y'], val_df_A1['pred_y'])
ATE_train = AIPW(train_df['t'], train_df['pred_t'], train_df['y'], train_df_A1['pred_y'])

ATE_AIPW = (ATE_val + ATE_train)/2
