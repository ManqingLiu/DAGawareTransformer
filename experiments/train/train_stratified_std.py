...
# print last 5 columns of dataframe
...
for loader_name, loader in loaders.items():
    ...
    wandb.init(
        ...
        project=f"dag-aware-transformer-{dataset_type}-stratified-std",
    ...
    save_model_stratified_std(model, treatment, dataset_type, loader_name, N_SAMPLE, N_EPOCHS,
